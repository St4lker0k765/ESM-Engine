...
public:
	...
	bool 		GetOpenName		(LPCSTR initial, string_path& buffer, int sz_buf, bool bMulti=false, LPCSTR offset=nullptr, int start_flt_ext=-1 );
	bool 		GetOpenName		(LPCSTR initial, xr_string& buf, bool bMulti=false, LPCSTR offset=nullptr, int start_flt_ext=-1 );

	bool 		GetSaveName		(LPCSTR initial, string_path& buffer, LPCSTR offset=nullptr, int start_flt_ext=-1 );
	bool 		GetSaveName		(LPCSTR initial, xr_string& buf, LPCSTR offset=nullptr, int start_flt_ext=-1 );
