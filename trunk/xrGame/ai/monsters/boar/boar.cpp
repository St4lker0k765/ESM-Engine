...
void CAI_Boar::reinit()
{
	...
	com_man().add_rotation_jump_data("stand_jump_left_0",nullptr,"stand_jump_right_0",nullptr, PI - PI_DIV_6, SControlRotationJumpData::eStopAtOnce | SControlRotationJumpData::eRotateOnce);
}
