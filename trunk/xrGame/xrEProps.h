...
public:
    ...
    virtual ChooseValue*		__stdcall	CreateChoose	    (PropItemVec& items, shared_str key, shared_str* val, u32 mode, LPCSTR path=nullptr, void* fill_param=nullptr, u32 sub_item_count=1, u32 choose_flags=cfAllowNone)=0;
    ...
    virtual Flag8Value*			__stdcall	CreateFlag8		    (PropItemVec& items, shared_str key, Flags8* val, u8 mask, LPCSTR c0=nullptr, LPCSTR c1=nullptr, u32 flags=0)=0;
    virtual Flag16Value*		__stdcall	CreateFlag16	    (PropItemVec& items, shared_str key, Flags16* val, u16 mask, LPCSTR c0=nullptr, LPCSTR c1=nullptr, u32 flags=0)=0;
    virtual Flag32Value*		__stdcall	CreateFlag32	    (PropItemVec& items, shared_str key, Flags32* val, u32 mask, LPCSTR c0=nullptr, LPCSTR c1=nullptr, u32 flags=0)=0;
	...
	virtual RToken16Value* 		__stdcall	CreateRToken16	    (PropItemVec& items, shared_str key, u16* val, xr_rtoken* token, u32 t_cnt)=0;
	virtual RToken32Value* 		__stdcall	CreateRToken32	    (PropItemVec& items, shared_str key, u32* val, xr_rtoken* token, u32 t_cnt)=0;
	...
	virtual RTextValue* 		__stdcall	CreateNameCB		(PropItemVec& items, shared_str key, shared_str* val, TOnDrawTextEvent=nullptr, RTextValue::TOnBeforeEditEvent=nullptr, RTextValue::TOnAfterEditEvent=nullptr)=0;
...
public:
	virtual ListItem*			__stdcall	CreateItem			(ListItemsVec& items, LPCSTR key, int type, u32 item_flags=0, void* object=nullptr)=0;
};
