...
#if defined(USE_DX10)
using ID3DDebug = ID3D10Debug;
using ID3DInfoQueue = ID3D10InfoQueue;
using D3D_MESSAGE_ID = D3D10_MESSAGE_ID;
using D3D_INFO_QUEUE_FILTER = D3D10_INFO_QUEUE_FILTER;
#define D3D_MESSAGE_ID_SETPRIVATEDATA_CHANGINGPARAMS D3D10_MESSAGE_ID_SETPRIVATEDATA_CHANGINGPARAMS
#define D3D_MESSAGE_SEVERITY_CORRUPTION D3D10_MESSAGE_SEVERITY_CORRUPTION
#define D3D_MESSAGE_SEVERITY_ERROR D3D10_MESSAGE_SEVERITY_ERROR
#endif
#endif
