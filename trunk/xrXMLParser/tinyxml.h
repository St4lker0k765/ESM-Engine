...
//	    friend std::ostream& operator<< (std::ostream& out, const TiXmlNode& base);
	...
	*/
    ...
    #ifdef TIXML_USE_STL
	const TiXmlNode* FirstChild( const xr_string& _value ) const	{	return FirstChild (_value.c_str ());	}	///< STL xr_string form.
	TiXmlNode* FirstChild( const xr_string& _value )				{	return FirstChild (_value.c_str ());	}	///< STL xr_string form.
	const TiXmlNode* LastChild( const xr_string& _value ) const	{	return LastChild (_value.c_str ());	}	///< STL xr_string form.
	...
	*/
    ...
    #ifdef TIXML_USE_STL
	const TiXmlNode* IterateChildren( const xr_string& _value, const TiXmlNode* previous ) const	{	return IterateChildren (_value.c_str (), previous);	}	///< STL xr_string form.
	TiXmlNode* IterateChildren( const xr_string& _value, const TiXmlNode* previous ) {	return IterateChildren (_value.c_str (), previous);	}	///< STL xr_string form.
	#endif
	...
	*/
    ...
    #ifdef TIXML_USE_STL
	const TiXmlNode* PreviousSibling( const xr_string& _value ) const	{	return PreviousSibling (_value.c_str ());	}	///< STL xr_string form.
	TiXmlNode* PreviousSibling( const xr_string& _value ) 			{	return PreviousSibling (_value.c_str ());	}	///< STL xr_string form.
	const TiXmlNode* NextSibling( const xr_string& _value) const		{	return NextSibling (_value.c_str ());	}	///< STL xr_string form.
	...
	*/
    ...
    #ifdef TIXML_USE_STL
	const TiXmlElement* NextSiblingElement( const xr_string& _value) const	{	return NextSiblingElement (_value.c_str ());	}	///< STL xr_string form.
	TiXmlElement* NextSiblingElement( const xr_string& _value)				{	return NextSiblingElement (_value.c_str ());	}	///< STL xr_string form.
	#endif
    ...
    #ifdef TIXML_USE_STL
	const TiXmlElement* FirstChildElement( const xr_string& _value ) const	{	return FirstChildElement (_value.c_str ());	}	///< STL xr_string form.
	TiXmlElement* FirstChildElement( const xr_string& _value )				{	return FirstChildElement (_value.c_str ());	}	///< STL xr_string form.
	#endif
...
public:
	...
	#ifdef TIXML_USE_STL
	/// xr_string constructor.
	TiXmlElement( const xr_string& _value );
	#endif
	...
	*/
    ...
    #ifdef TIXML_USE_STL
	const xr_string* Attribute( const xr_string& name ) const;
	const xr_string* Attribute( const xr_string& name, int* i ) const;
	const xr_string* Attribute( const xr_string& name, double* d ) const;
	int QueryIntAttribute( const xr_string& name, int* _value ) const;
	int QueryDoubleAttribute( const xr_string& name, double* _value ) const;

	/// STL xr_string form.
	void SetAttribute( const xr_string& name, const xr_string& _value );
	///< STL xr_string form.
	void SetAttribute( const xr_string& name, int _value );
	#endif
	...
	*/
    ...
    #ifdef TIXML_USE_STL
	void RemoveAttribute( const xr_string& name )	{	RemoveAttribute (name.c_str ());	}	///< STL xr_string form.
	#endif
...
#ifdef TIXML_USE_STL
	/// Constructor.
	TiXmlDeclaration(	const xr_string& _version,
...
public:
	...
	#ifdef TIXML_USE_STL
	/// Constructor.
	TiXmlDocument( const xr_string& documentName );
	#endif
	...
	*/
	...
	#ifdef TIXML_USE_STL
	bool LoadFile( const xr_string& filename, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING )			///< STL xr_string version.
	{
//		StringToBuffer f( filename );
//		return ( f.buffer && LoadFile( f.buffer, encoding ));
		return LoadFile( filename.c_str(), encoding );
	}
	bool SaveFile( const xr_string& filename ) const		///< STL xr_string version.
	{
//		StringToBuffer f( filename );
...
public:
	...
	*/
	...
	#ifdef TIXML_USE_STL
	TiXmlHandle FirstChild( const xr_string& _value ) const				{ return FirstChild( _value.c_str() ); }
	TiXmlHandle FirstChildElement( const xr_string& _value ) const		{ return FirstChildElement( _value.c_str() ); }

	TiXmlHandle Child( const xr_string& _value, int index ) const			{ return Child( _value.c_str(), index ); }
	TiXmlHandle ChildElement( const xr_string& _value, int index ) const	{ return ChildElement( _value.c_str(), index ); }
	#endif
...
public:
	...
	*/
	...
	#ifdef TIXML_USE_STL
	/// Return the result.
	const xr_string& Str()						{ return buffer; }
	#endif
